...
class MLP:
    ...
    def train(self, train_data, train_labels, batch_size=64, epochs=10):
        self.model.fit(train_data, train_labels, batch_size=batch_size, epochs=epochs, validation_split=0.1, verbose=0)
...
if __name__ == "__main__":
    ...
    mlp = MLP(hidden_dims=[128, 64], output_dim=10) #> input dim tự điều chỉnh(theo input model)
